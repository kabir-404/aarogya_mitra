      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="items-center" ref={ref}>
          ...
          <div className="space-y-5">
            ...
            >
              Aarogya Mitra Healthcare Foundation was born from a simple
              observation — millions of families in Nagpur struggle to access
              even basic healthcare. Est. 2026, we set out with one mission:
              make quality healthcare{" "}
              <strong className="text-gray-800">
                accessible and affordable
              </strong>{" "}
              for every individual, regardless of their economic background.
            </motion.p>
            ...
            >
              From LIG Quarters, Rambag Colony, Nagpur, we navigate the complex
              maze of hospitals, government schemes, and medical systems — so
